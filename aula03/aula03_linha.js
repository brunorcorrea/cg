...
const render = () => {
  ...
  vertices = [downConvertedCoords.convertedX, downConvertedCoords.convertedY, moveConvertedCoords.convertedX, moveConvertedCoords.convertedY];
  console.log("\n\n\n\n" + vertices + "\n\n\n\n")
  ...
  gl.clear(gl.DEPTH_BUFFER_BIT | gl.COLOR_BUFFER_BIT);
  gl.drawArrays(gl.LINES, 0, vertices / 2);
};
