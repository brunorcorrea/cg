...
const render = () => {
  ...
  vertices = [downConvertedCoords.convertedX, downConvertedCoords.convertedY
    , moveConvertedCoords.convertedX, moveConvertedCoords.convertedY
    , downConvertedCoords.convertedX, moveConvertedCoords.convertedY];
  console.log("\n\n\n\n" + vertices + "\n\n\n\n")
...
canvas.addEventListener("mousemove", (e) => {
  if (isDown) {
    ...
    moveY = e.offsetY;
    render();
    console.log(downX, downY, moveX, moveY);
  }
});
